...
We are interested in finding factors that would affect the price of used cars and whether different brands of cars would have different influential factors. So we split the data by the top 5 brands of used cars. We got the brands' name by listing the top 5 brands and their corresponding frequency from the first 6000 lines of our data. The frequency table is as follows:
